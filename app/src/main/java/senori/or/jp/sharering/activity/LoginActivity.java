...
import senori.or.jp.sharering.info.CDlalog;
...
//
            ...
            list.add(new BasicNameValuePair("email", mEmail));
            list.add(new BasicNameValuePair("pw", mPassword));
            ...
            if (success) {
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        Log.e("test", id + "" + nicname + "" + email + "" + day);
                    }
