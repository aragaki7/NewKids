package senori.or.jp.sharering.calendar;
...
public class CalendarView {
    ...
    // / ������ 2�� 4 5 6�̶��
    // / [0204] [0205] [0206] �̷��� ����
    private ArrayList<String> m_holiDay = new ArrayList<String>();
    ...
    /**
     * @deprecated String Add data -> MM/dd
     **/
    public void addHoliday(String holiday_MMdd) {
        m_holiDay.add(holiday_MMdd);
    }

    /**
     * @deprecated void get_Holiday datColor
     */
    public void applyHoliday(int button, int day) {
        // / ���� �޷��� ���� ����
